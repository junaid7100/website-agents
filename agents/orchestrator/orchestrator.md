...
1. Dispatch the `copywriting` subagent, pointing it at `./02-copywriting/`
...
3. Only send it pages marked **Ready** in `12-COPYWRITING-HANDOFF.md`. Pages
   marked **BLOCKED / NEEDS INPUT** stay out of this phase until the user
   resolves them — surface the blockers instead of guessing.
